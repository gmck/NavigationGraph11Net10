...
{
    [Application]
    public class NavigationGraph11ApplicationNet10 : Application, Application.IActivityLifecycleCallbacks
    {
        protected readonly string logTag = "Nav-ApplicationClass";
        protected NavigationGraph11ApplicationNet10(IntPtr javaReference, JniHandleOwnership transfer) : base(javaReference, transfer)
        {

        }
        public NavigationGraph11ApplicationNet10() { }
