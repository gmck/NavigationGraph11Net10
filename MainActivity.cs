...
namespace com.companyname.navigationgraph11net10
{
                                ...
                                NavigationView.IOnNavigationItemSelectedListener
    {
        ...
        // The NavigationView in the NavigationGraph11Net10 example is a very simple menu.
        ...
        private void ShowWelcomeMessage()
        {
            ...
            string message = GetString(Resource.String.welcome_navigationgraph11net10) + " - Version: " + packageInfo.VersionName;
            if (showSnackBar)
